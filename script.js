...
let time=30;
let timer;
let colors=['red','orange','green','black','blue','grey','white','hotpink','purple','lightgreen','maroon','khaki','brown','navy','indigo','yellow'];
...
function lightMode(){
    document.body.style.backgroudColor="#f0f0f0";
...
function darkMode(){
    document.body.style.backgroudColor="#333333";
    let gc=document.querySelector(".game-container");
